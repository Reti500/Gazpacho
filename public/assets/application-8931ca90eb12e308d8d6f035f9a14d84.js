...
;
(function() {
  this.app = angular.module('App', ['ngResource', 'ngRoute', 'ui.bootstrap', 'Authentication']);

  this.authentication = angular.module('Authentication', []).factory('Session', function() {
  ...
  this.app.config([
    '$routeProvider', function($routeProvider) {
      ...
      for (path in window.routes) {
        _results.push($routeProvider.when(path, window.routes[path]));
      }
      return _results;
    }
  ]);
  ...
  this.app.run(function($rootScope, $location, Session, Login) {
    return $rootScope.$on("$routeChangeStart", function($event, $next, $current) {
      return Login.verify({}, function($data) {
...
(function() {
  this.app.controller('FormsCtrl', [
    '$scope', '$routeParams', 'Form', 'Project', function($scope, $routeParams, Form, Project) {
      $scope.index = function() {
        Form.index({}, function($data) {
          return $scope.forms = $data.forms;
        });
        return Project.index({}, function($data) {
      ...
      $scope.show = function() {
        ...
        return Form.show({
          ...
          return $scope.form = $data.form;
        });
      };
      $scope.nuevo = function($params) {
        $scope.form = new Form($params);
        return Form.create($scope.form, function($data) {
          $scope.forms.push($data.form);
          return $scope.form = angular.copy({});
        });
      };
      return $scope.ver_pregunta = function() {};
    }
  ]);
...
(function() {
  this.app.controller('HomeCtrl', [
    '$scope', '$modal', '$log', function($scope, $modal, $log) {
      $scope.items = [];
      return $scope.message = "Angular!";
    }
  ]);

}).call(this);
(function() {
  this.app.controller('ProjectsCtrl', [
    '$scope', '$routeParams', '$location', '$log', 'Project', 'Session', function($scope, $routeParams, $location, $log, Project, Session) {
      ...
      $scope.detalles = function($project) {
        return $location.path("/projects/" + $project.id);
      };
      $scope.show = function() {
        return Project.show({
          id: $routeParams.id
        }, function($data) {
          return $scope.project = $data.project;
        });
      };
      $scope.nuevo = function($params) {
        $log.info($params);
        $scope.project = new Project($params);
        return Project.create($scope.project, function($data) {
...
(function() {
  this.app.controller('SessionsCtrl', [
    '$scope', '$location', 'Login', 'Session', function($scope, $location, Login, Session) {
      $scope.alerts = [];
      $scope.a = "ok";
      $scope.crear = function(params) {
        $scope.login = new Login(params);
        return Login.create($scope.login, function($data) {
          if ($data.user !== null) {
            Session.activate();
            ...
            return $scope.session = angular.copy({});
          }
        });
      };
      $scope.addAlert = function(tipo, msj) {
